...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "profiles",
    price: 1200,
    images: ["/images/products/profile-gold.png"],
    stockCount: 0,
    inStock: false,
  ...
  },
  {
    ...
    category: "profiles",
    price: 950,
    images: ["/images/products/profile-shadow-black.png"],
    stockCount: 0,
    inStock: false,
  ...
  },
  {
    ...
    price: 2450,
    images: ["/images/products/mounting-kit-pro.png"],
    stockCount: 100,
    inStock: true,
    ...
    bundleItems: [
      { id: "b1", name: "Шпатель зубчатый", price: 450, quantity: 1, image: "/images/products/notched-trowel.png", slug: "notched-trowel", inStock: true, stockCount: 100 },
      { id: "b2", name: "Уровень строительный", price: 850, quantity: 1, image: "/images/products/spirit-level.jpg", slug: "spirit-level", inStock: true, stockCount: 100 },
      { id: "b3", name: "Клей UltraFix (пробник)", price: 650, quantity: 2, image: "/images/products/ultrafix-sample.png", slug: "ultrafix-sample", inStock: true, stockCount: 100 },
      { id: "b4", name: "Набор крепежей", price: 500, quantity: 1, image: "/images/products/mounting-hardware.png", slug: "mounting-hardware", inStock: true, stockCount: 100 }
    ]
  },
  // Товары для наборов (скрытые из общего каталога)
  {
    ...
    category: "accessories",
    price: 450,
    images: ["/images/products/notched-trowel.png"],
    stockCount: 100,
    inStock: true,
  ...
  },
  {
    ...
    category: "accessories",
    price: 850,
    images: ["/images/products/spirit-level.jpg"],
    stockCount: 100,
    inStock: true,
  ...
  },
  {
    ...
    category: "accessories",
    price: 650,
    images: ["/images/products/ultrafix-sample.png"],
    stockCount: 100,
    inStock: true,
  ...
  },
  {
    ...
    category: "accessories",
    price: 500,
    images: ["/images/products/mounting-hardware.png"],
    stockCount: 100,
    inStock: true,
  ...
  },
  {
    ...
    category: "accessories",
    price: 1100,
    images: ["/images/products/glue-ultrafix.png"],
    stockCount: 100,
    inStock: true,
  ...
  },
  {
    ...
    category: "accessories",
    price: 3200,
    images: ["/images/products/glue-ultrafix-5kg.png"],
    stockCount: 100,
    inStock: true,
  ...
  },
  {
    ...
    category: "accessories",
    price: 1800,
    images: ["/images/products/grout-stone-finish-2kg.png"],
    stockCount: 100,
    inStock: true,
